...
<span class="body-2">.bg-{'{color}-{variant}'}</span>
...
<span class="body-2">.text-{'{color}-{variant}'}</span>
...
<span class="body-2">border-{'{n}'}</span>
and type
<span class="body-2">border-{'{solid|dashed|dotted|none}'}</span>
helpers.
<Code
