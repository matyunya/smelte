...
<p>
  This will append <span class="code-inline">mode-dark</span> class to the document body
  which will enable all generated classes preceded by pseudo-class "dark:".
  By default smelte generates following variants:
</p>
...
<p>
Now you can use dark theme classes like <span class="code-inline">dark:bg-white</span>
